...
class DOOM1993World(World):
    ...
    starting_level_for_episode: List[str] = ["Hangar (E1M1)", "Deimos Anomaly (E2M1)", "Hell Keep (E3M1)"]
    ...
    def set_rules(self):
        ...
        if getattr(self.multiworld, "allow_death_logic")[self.player]:
            self.multiworld.exclude_locations[self.player].value |= set(Locations.death_logic_locations)
    ...
    def create_items(self):
        ...
        if self.included_episodes[1]:
            self.place_locked_item_in_locations(
    ...
    def get_filler_item_name(self):
        return self.multiworld.random.choice(
            ["Medikit", "Box of bullets", "Box of rockets", "Box of shotgun shells", "Energy cell pack"]
        )
