...
regions: List[RegionDict] = [
    # Hangar (E1M1)
    {"name": "Hangar (E1M1) Main", "connects_to_hub": True, "episode": 1, "connections": []},
    # Nuclear Plant (E1M2)
    {
    ...
    },
    {
        ...
        "connects_to_hub": False,
        "episode": 1,
        "connections": ["Toxin Refinery (E1M3) Yellow", "Toxin Refinery (E1M3) Main"],
    },
    {
    ...
    # Command Control (E1M4)
    {
        ...
        "connects_to_hub": True,
        "episode": 1,
        "connections": ["Command Control (E1M4) Blue", "Command Control (E1M4) Yellow"],
    },
    {
    ...
    },
    {
        ...
        "connects_to_hub": False,
        "episode": 1,
        "connections": ["Phobos Lab (E1M5) Main", "Phobos Lab (E1M5) Blue", "Phobos Lab (E1M5) Green"],
    },
    {
        "name": "Phobos Lab (E1M5) Blue",
        "connects_to_hub": False,
        "episode": 1,
        "connections": ["Phobos Lab (E1M5) Green", "Phobos Lab (E1M5) Yellow"],
    },
    {
        "name": "Phobos Lab (E1M5) Green",
        "connects_to_hub": False,
        "episode": 1,
        "connections": ["Phobos Lab (E1M5) Main", "Phobos Lab (E1M5) Blue"],
    },
    ...
    # Computer Station (E1M7)
    {
        ...
        "connects_to_hub": True,
        "episode": 1,
        "connections": ["Computer Station (E1M7) Red", "Computer Station (E1M7) Yellow"],
    },
    {
    ...
    # Phobos Anomaly (E1M8)
    {"name": "Phobos Anomaly (E1M8) Main", "connects_to_hub": False, "episode": 1, "connections": []},
    {
    ...
    # Military Base (E1M9)
    {
        ...
        "connects_to_hub": True,
        "episode": 1,
        "connections": ["Military Base (E1M9) Blue", "Military Base (E1M9) Yellow", "Military Base (E1M9) Red"],
    },
    {
    ...
    # Deimos Anomaly (E2M1)
    {
        ...
        "connects_to_hub": True,
        "episode": 2,
        "connections": ["Deimos Anomaly (E2M1) Red", "Deimos Anomaly (E2M1) Blue"],
    },
    {
    ...
    # Refinery (E2M3)
    {"name": "Refinery (E2M3) Main", "connects_to_hub": True, "episode": 2, "connections": ["Refinery (E2M3) Blue"]},
    {"name": "Refinery (E2M3) Blue", "connects_to_hub": False, "episode": 2, "connections": ["Refinery (E2M3) Main"]},
    # Deimos Lab (E2M4)
    {
    ...
    },
    {
        ...
        "connects_to_hub": False,
        "episode": 2,
        "connections": ["Deimos Lab (E2M4) Main", "Deimos Lab (E2M4) Yellow"],
    },
    {
    ...
    # Command Center (E2M5)
    {"name": "Command Center (E2M5) Main", "connects_to_hub": True, "episode": 2, "connections": []},
    ...
    # Tower of Babel (E2M8)
    {"name": "Tower of Babel (E2M8) Main", "connects_to_hub": True, "episode": 2, "connections": []},
    ...
    },
    {
        ...
        "connects_to_hub": False,
        "episode": 3,
        "connections": ["House of Pain (E3M4) Main", "House of Pain (E3M4) Yellow", "House of Pain (E3M4) Red"],
    },
    {
    ...
    # Unholy Cathedral (E3M5)
    {
        ...
        "connects_to_hub": True,
        "episode": 3,
        "connections": ["Unholy Cathedral (E3M5) Yellow", "Unholy Cathedral (E3M5) Blue"],
    },
    {
    ...
    # Limbo (E3M7)
    {
        ...
        "connects_to_hub": True,
        "episode": 3,
        "connections": ["Limbo (E3M7) Red", "Limbo (E3M7) Blue"],
    },
    {"name": "Limbo (E3M7) Blue", "connects_to_hub": False, "episode": 3, "connections": ["Limbo (E3M7) Main"]},
    {
        "name": "Limbo (E3M7) Red",
        "connects_to_hub": False,
        "episode": 3,
        "connections": ["Limbo (E3M7) Main", "Limbo (E3M7) Yellow"],
    },
    {"name": "Limbo (E3M7) Yellow", "connects_to_hub": False, "episode": 3, "connections": ["Limbo (E3M7) Red"]},
    # Dis (E3M8)
    {"name": "Dis (E3M8) Main", "connects_to_hub": True, "episode": 3, "connections": []},
    # Warrens (E3M9)
    {
        "name": "Warrens (E3M9) Main",
        "connects_to_hub": True,
        "episode": 3,
        "connections": ["Warrens (E3M9) Blue", "Warrens (E3M9) Blue trigger"],
    },
    {"name": "Warrens (E3M9) Red", "connects_to_hub": False, "episode": 3, "connections": []},
    {
        "name": "Warrens (E3M9) Blue",
        "connects_to_hub": False,
        "episode": 3,
        "connections": ["Warrens (E3M9) Main", "Warrens (E3M9) Red"],
    },
    {"name": "Warrens (E3M9) Blue trigger", "connects_to_hub": False, "episode": 3, "connections": []},
    # Hell Beneath (E4M1)
    {
        "name": "Hell Beneath (E4M1) Main",
        "connects_to_hub": True,
        "episode": 4,
        "connections": ["Hell Beneath (E4M1) Red", "Hell Beneath (E4M1) Blue"],
    },
    {
    ...
    # Perfect Hatred (E4M2)
    {
        ...
        "connects_to_hub": True,
        "episode": 4,
        "connections": ["Perfect Hatred (E4M2) Blue", "Perfect Hatred (E4M2) Yellow"],
    },
    {
        "name": "Perfect Hatred (E4M2) Blue",
        "connects_to_hub": False,
        "episode": 4,
        "connections": ["Perfect Hatred (E4M2) Main", "Perfect Hatred (E4M2) Cave"],
    },
    {
    ...
    {"name": "Perfect Hatred (E4M2) Cave", "connects_to_hub": False, "episode": 4, "connections": []},
    ...
    },
    {
        ...
        "connects_to_hub": False,
        "episode": 4,
        "connections": ["Sever the Wicked (E4M3) Blue", "Sever the Wicked (E4M3) Main"],
    },
    {
    ...
    # Unto the Cruel (E4M8)
    {
        ...
        "connects_to_hub": True,
        "episode": 4,
        "connections": ["Unto the Cruel (E4M8) Red", "Unto the Cruel (E4M8) Yellow", "Unto the Cruel (E4M8) Orange"],
    },
    {
    ...
    # Fear (E4M9)
    {"name": "Fear (E4M9) Main", "connects_to_hub": True, "episode": 4, "connections": ["Fear (E4M9) Yellow"]},
    {"name": "Fear (E4M9) Yellow", "connects_to_hub": False, "episode": 4, "connections": ["Fear (E4M9) Main"]},
]
